    ...
    return (
        <div className="max-w-4xl mx-auto pb-12">
            <div className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h1 className="text-4xl font-black text-gray-900 font-outfit uppercase tracking-tighter">Nouveau Dossier (Admin)</h1>
                    <p className="text-gray-500 font-medium">Assistant de création de dossier Import/Export.</p>
                </div>
                <button
                    onClick={() => navigate('/dashboard/logistique')}
                    className="flex items-center gap-3 px-6 py-3 bg-white border-2 border-gray-100 rounded-2xl shadow-sm hover:bg-gray-50 transition-colors"
                >
                    <ArrowLeft className="w-4 h-4 text-gray-600" />
                    <span className="text-xs font-black text-gray-900 uppercase tracking-widest">Retour au tableau</span>
                </button>
            </div>
